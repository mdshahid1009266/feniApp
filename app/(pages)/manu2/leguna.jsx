...
import { createLegunaOrder } from '../../api';
...
export default function TruckRentalScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await createLegunaOrder(formData);
      if (!response) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.header}>লেগুনা বুকিং ফর্ম</Text>
      ...
      {/* Truck Type Selector */}
      <View style={styles.formGroup}>
        <Text style={styles.label}>লেগুনার ধরন *</Text>
        <TouchableOpacity
        ...
        >
          <Text style={formData.truckType ? styles.carTypeSelectedText : styles.placeholderText}>
            {formData.truckType || 'লেগুনার ধরন নির্বাচন করুন'}
          </Text>
        </TouchableOpacity>
